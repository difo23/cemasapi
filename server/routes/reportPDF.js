...
app.get('/pdf/:curso/:periodo',(req, res)=>{
    ...
    PromiseBlue.props({
            reportes: Reportes.find({ periodo: `${periodo}:${curso}`},
            "nombre_estudiante rne curso periodo numero_estudiante rne titular_codigo boletin  asignaturas modulos" ).execAsync()
        }).then((result) => {
